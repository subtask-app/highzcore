        ...
        <div className="bg-slate-900/80 backdrop-blur-xl border border-blue-500/30 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <div className="mt-6 flex items-center gap-2 bg-blue-500/10 border border-blue-500/30 rounded-full px-4 py-2">
              ...
              <span className="text-sm text-blue-400 font-medium">Creator Account</span>
            </div>
            <p className="text-gray-400 text-center mt-4">
              Create your account to start growing your YouTube channel
            </p>
          </div>
          ...
          <div className="space-y-3 text-sm text-gray-400 mb-6">
            <div className="flex items-start gap-2">
              ...
              <p>Real subscribers to reach 1,000 for monetization</p>
            </div>
            <div className="flex items-start gap-2">
              <div className="w-1.5 h-1.5 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
              <p>Track your subscriber growth in real-time</p>
            </div>
            <div className="flex items-start gap-2">
              <div className="w-1.5 h-1.5 rounded-full bg-blue-400 mt-2 flex-shrink-0" />
          ...
          <div className="text-center text-sm text-gray-400">
            ...
            <Link href="/login/client" className="text-blue-400 hover:text-blue-300 font-semibold transition-colors">
              Sign in
            </Link>
          </div>
        </div>
