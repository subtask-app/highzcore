    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <Card padding="lg">
            ...
            project?.type === 'insights'
              ...
              : project?.type === 'abtest'
                ...
                : project?.type === 'promote'
                  ? 'You have this task. Share the video to your audience and submit the post URL.'
                  : 'You have this task. The completion form for this product type will live here once M9 ships.'
          )}
        ...
        <div className="mt-4 flex gap-2">
          ...
          {task.status === 'claimed' && project?.type === 'promote' && (
            <LinkButton href={`/worker/tasks/${task.id}/promote`}>Open share form</LinkButton>
          )}
