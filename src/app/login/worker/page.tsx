        ...
        <div className="bg-slate-900/80 backdrop-blur-xl border border-blue-500/30 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <div className="mt-6 flex items-center gap-2 bg-blue-500/10 border border-blue-500/30 rounded-full px-4 py-2">
              ...
              <span className="text-sm text-blue-400 font-medium">Worker Sign In</span>
            </div>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-slate-900 text-gray-400">Why Google?</span>
            </div>
          </div>
          ...
          <div className="text-center text-sm text-gray-400">
            ...
            <Link href="/signup/worker" className="text-blue-400 hover:text-blue-300 font-semibold transition-colors">
              Sign up as Worker
            </Link>
          </div>
        </div>
